...
> **Storage scope:** this is a local, single-process SeaweedFS `mini` proof-of-concept for development and migration validation. It is not a production SeaweedFS cluster.
...
- **SeaweedFS mini** – S3-compatible storage
